...
Usage:
  ...
  feeling [-tracker value] [-tracker value] <mood>    add a records to a custom trackers linked to a mood

  feeling !                                           create a oneshot task (interactive)
  ...
  feeling @[:o|:O]                                   view pending tasks
                                                        (all / oneshots / recurring+scheduled)
  feeling @done[:o|:O]                               view completed tasks
  feeling @due[:t|:w]                                due (today / tomorrow / this week) view
